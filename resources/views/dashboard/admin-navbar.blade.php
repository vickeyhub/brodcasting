    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('dashboard') ? 'bg-danger text-white':''}}" aria-current="page" href="{{ url('/dashboard')}}">Add Alert</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('all-alerts') ? 'bg-danger text-white':''}}"" href="{{ url('/all-alerts')}}">All Alerts</a>
                    </li>
